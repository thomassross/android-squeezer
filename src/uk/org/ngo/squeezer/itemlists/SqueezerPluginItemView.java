...
public class SqueezerPluginItemView extends SqueezerIconicItemView<SqueezerPluginItem> {
    ...
    public void setupContextMenu(Menu menu, int index, SqueezerPluginItem item) {
		if (!item.isHasitems()) {
            menu.add(Menu.NONE, R.id.play_now, 1, R.string.CONTEXTMENU_PLAY_ITEM);
            menu.add(Menu.NONE, R.id.add_to_playlist, 2, R.string.CONTEXTMENU_ADD_ITEM);
            menu.add(Menu.NONE, R.id.play_next, 3, R.string.CONTEXTMENU_INSERT_ITEM);
		}
	}
